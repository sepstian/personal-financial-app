...
const Dashboard = () => {
  ...
  const processChartData = () => {
    ...
    // Remove the date property after sorting
    balanceData.forEach(data => delete data.date);
      ...
      {loading ? (
        ...
        <>
          ...
          {transactions.length === 0 ? (
            ...
            <>
              <Row gutter={16}>
                <Card bordered={true} style={isMobile ? cardRespon : cardStyle}>
                  <h2>Financial Statistics</h2>
                  <Line {...{ ...balanceConfig, data: balanceData }} />
                </Card>

                <Card bordered={true} style={isMobile ? { ...cardRespon, marginBottom:"20px" } : { ...cardStyle, flex: 0.45 }}>
